<div class="flex justify-between items-center">
    <div class="flex gap-2 items-center">
        ...
        <div>
            <h1 class="text-xl font-semibold text-green-500">PORTAL MAHASISWA</h1>
...
<div class="mt-3 flex flex-col gap-2 font-semibold text-sm text-gray-600">
    ...
    <a href="/rekapitulasi-hasil-studi"
        class="p-3 rounded flex gap-2 items-center @if (Request::is('rekapitulasi-hasil-studi*')) bg-green-500 text-white @else hover:text-green-500 @endif">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            <path fill-rule="evenodd"
    ...
    <a href="/khs"
        class="p-3 rounded flex gap-2 items-center @if (Request::is('khs*')) bg-green-500 text-white @else hover:text-green-500 @endif">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            <path fill-rule="evenodd"
    ...
    <a href="/registrasi-akademik"
        class="p-3 rounded flex gap-2 items-center @if (Request::is('registrasi-akademik*')) bg-green-500 text-white @else hover:text-green-500 @endif">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            <path
...
<div class="mt-3 flex flex-col gap-2 font-semibold text-sm text-gray-600">
    ...
    <a href="/jadwal-perkuliahan"
        class="p-3 rounded flex gap-2 items-center @if (Request::is('jadwal-perkuliahan*')) bg-green-500 text-white @else hover:text-green-500 @endif">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            <path
